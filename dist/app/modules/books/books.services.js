...
const allBooks = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
...
const categoriesBooks = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.prisma.book.findMany({
        where: {
            categoryId: id,
        },
...
const singleBooks = (id) => __awaiter(void 0, void 0, void 0, function* () {
